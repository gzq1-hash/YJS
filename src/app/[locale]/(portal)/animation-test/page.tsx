      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-32">
          ...
          <div className="min-h-[200px] border-2 border-black dark:border-white rounded-lg flex items-center justify-center p-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-black">
            <ModernTextAnimation key={keys.typewriter} text="元金石 AurumFoundry" type="typewriter" />
          </div>
        </div>
        ...
        <div className="mb-32">
          ...
          <div className="min-h-[200px] border-2 border-black dark:border-white rounded-lg flex items-center justify-center p-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-black">
            <ModernTextAnimation key={keys.gradient} text="元金石 AurumFoundry" type="gradient" />
          </div>
        </div>
        ...
        <div className="mb-32">
          ...
          <div className="min-h-[200px] border-2 border-black dark:border-white rounded-lg flex items-center justify-center p-8 bg-black dark:bg-gray-950">
            <ModernTextAnimation key={keys.glitch} text="元金石 AurumFoundry" type="glitch" />
          </div>
        </div>
        ...
        <div className="mb-32">
          ...
          <div className="min-h-[200px] border-2 border-black dark:border-white rounded-lg flex items-center justify-center p-8 bg-black dark:bg-gray-950">
            <ModernTextAnimation key={keys.neon} text="元金石 AurumFoundry" type="neon" />
          </div>
        </div>
        ...
        <div className="mb-32">
          ...
          <div className="min-h-[200px] border-2 border-black dark:border-white rounded-lg flex items-center justify-center p-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-black">
            <ModernTextAnimation key={keys.scale} text="元金石 AurumFoundry" type="scale" />
          </div>
        </div>
        ...
        <div className="mb-32">
          ...
          <div className="min-h-[200px] border-2 border-black dark:border-white rounded-lg flex items-center justify-center p-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-black">
            <ModernTextAnimation key={keys.split} text="元金石 AurumFoundry" type="split" />
          </div>
        </div>
