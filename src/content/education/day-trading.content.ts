...
export const dayTradingContent = {
  zh: {
    title: '日内交易完整指南丨元金石丨职业交易员培训、日内交易员培训',
    ...
    ctaTitle: '想要系统学习日内交易？',
    ctaDescription: '加入 AurumFoundry 培训计划，获取专业日内交易策略和实时交易指导',
  ...
  en: {
    title: 'Complete Day Trading Guide丨AurumFoundry丨Professional Trader Training, Day Trader Training',
    ...
    ctaDescription: 'Join AurumFoundry training for professional day trading strategies and live trading guidance',
